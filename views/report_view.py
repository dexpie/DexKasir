...
class ReportView(ctk.CTkFrame):
    ...
    def create_report_tab(self):
        ...
        # Summary
        self.lbl_revenue = ctk.CTkLabel(self.tab_report, text="Total Pendapatan: Rp 0", font=("Roboto Medium", 18))
        self.lbl_revenue.pack(pady=10)
        
        # Table
        frame_table = ctk.CTkFrame(self.tab_report)
        frame_table.pack(fill="both", expand=True, padx=10, pady=5)
        
        cols = ('id', 'date', 'cashier', 'subtotal', 'disc', 'tax', 'total')
        ...
        self.tree.heading('disc', text='Diskon')
        self.tree.heading('tax', text='Pajak')
        ...
        self.tree.column('disc', width=60)
        self.tree.column('tax', width=60)
    ...
    def load_report_data(self):
        ...
        data, total = self.report_model.get_monthly_sales(m, y)
        self.current_report_data = data
        self.lbl_revenue.configure(text=f"Total Pendapatan: {format_rupiah(total)}")
        ...
        for t in data:
            self.tree.insert('', tk.END, values=(
                ...
                format_rupiah(t.get('subtotal', 0)),
                format_rupiah(t.get('discount', 0)),
                format_rupiah(t.get('tax', 0)),
    ...
    def load_analytics(self):
        ...
        # Need to aggregate transaction_items. Group by product_name, sum quantity.
        # Ideally this goes to ReportModel, but fast implementation here:
